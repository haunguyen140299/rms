...
public class TemplateEvaluation {
    ...
    public TemplateEvaluation() {
    }

    public TemplateEvaluation(int template_evaluation_id, String template_evaluation_name, int creater_id, Date day_of_create) {
